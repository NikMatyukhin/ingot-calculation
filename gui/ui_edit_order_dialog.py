...
"}")
        ...
        self.thickness_area = QtWidgets.QFrame(self.complects_area)
        self.thickness_area.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.thickness_area.setFrameShadow(QtWidgets.QFrame.Raised)
        self.thickness_area.setObjectName("thickness_area")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.thickness_area)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setSpacing(5)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.thickness_label = QtWidgets.QLabel(self.thickness_area)
        self.thickness_label.setObjectName("thickness_label")
        self.horizontalLayout_3.addWidget(self.thickness_label)
        self.thickness = QtWidgets.QDoubleSpinBox(self.thickness_area)
        self.thickness.setMinimum(0.1)
        self.thickness.setObjectName("thickness")
        self.horizontalLayout_3.addWidget(self.thickness)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_4.addWidget(self.thickness_area)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.thickness_label.setText(_translate("Dialog", "Толщина реза"))
        self.thickness.setSuffix(_translate("Dialog", " мм"))
